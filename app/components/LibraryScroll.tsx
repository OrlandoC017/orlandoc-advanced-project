...
const API_URL = `https://us-central1-summaristt.cloudfunctions.net/getBooks?status=recommended`;

export default function LibraryScrollRecommended() {
  ...
  return (
    <>
      <div className="heading__text">
        <h2 className="section__title mb-0.5">Recommended for you</h2>
        <h3 className="text-center">We think you'll love these</h3>
      </div>
      ...
      <div className="for-you__books">
        {books.map((book) => (
          ...
          >
            ...
            <div className="for-you__books--author text-blue-500 font-bold">
              {book.author}
            </div>
